...
def upgrade():
    ...
    op.create_index(
        op.f("ix_ai_generated_content_content_id"),
        "ai_generated_content",
        ["content_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_automation_workflows_workflow_id"),
        "automation_workflows",
        ["workflow_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_content_calendar_calendar_id"),
        "content_calendar",
        ["calendar_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_content_calendar_scheduled_date"),
        "content_calendar",
        ["scheduled_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_trend_predictions_prediction_id"),
        "trend_predictions",
        ["prediction_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_ab_test_results_test_id"), "ab_test_results", ["test_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_competitor_analysis_analysis_id"),
        "competitor_analysis",
        ["analysis_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_performance_metrics_metric_id"),
        "performance_metrics",
        ["metric_id"],
        unique=True,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_performance_metrics_metric_id"), table_name="performance_metrics"
    )
    op.drop_table("performance_metrics")
    op.drop_index(
        op.f("ix_competitor_analysis_analysis_id"), table_name="competitor_analysis"
    )
    ...
    op.drop_index(
        op.f("ix_trend_predictions_prediction_id"), table_name="trend_predictions"
    )
    op.drop_table("trend_predictions")
    op.drop_index(
        op.f("ix_content_calendar_scheduled_date"), table_name="content_calendar"
    )
    op.drop_index(
        op.f("ix_content_calendar_calendar_id"), table_name="content_calendar"
    )
    op.drop_table("content_calendar")
    op.drop_index(
        op.f("ix_automation_workflows_workflow_id"), table_name="automation_workflows"
    )
    op.drop_table("automation_workflows")
    op.drop_index(
        op.f("ix_ai_generated_content_content_id"), table_name="ai_generated_content"
    )
